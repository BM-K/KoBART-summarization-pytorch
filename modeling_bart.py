...
class BartAttention(nn.Module):
    ...
    def forward(
        ...
        copy_weights = attn_weights.view(bsz, self.num_heads, tgt_len, src_len)
        ...
        return attn_output, copy_weights, past_key_value
...
class BartForConditionalGeneration(BartPretrainedModel):
    ...
    def forward(
        ...
        if labels is not None:
            ...
            #masked_lm_loss = self.label_sm(lm_logits.view(-1, self.config.vocab_size), labels.view(-1))
    ...
    def label_sm(self, x, target, smoothing=0.1):
